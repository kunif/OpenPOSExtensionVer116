...
{
    public static class ISoundPlayer116Constants
    {
        public const int statusStartPlaySound = 11;
        public const int statusStopPlaySound = 12;
        public const int ExtendedErrorNoRoom = 201;
    }

    public interface ISoundPlayer116
    {
        string CapAssociatedHardTotalsDevice { get; }
        bool CapMultiPlay { get; }
        string[] CapSoundTypeList { get; }
        CapStorageType CapStorage { get; }
        bool CapVolume { get; }
        string[] DeviceSoundList { get; }
        int[] OutputIdList { get; }
        StorageType Storage { get; set; }
        int Volume { get; set; }
        void PlaySound(string fileName, bool loop);
        void StopSound(int outputId);
    }
}